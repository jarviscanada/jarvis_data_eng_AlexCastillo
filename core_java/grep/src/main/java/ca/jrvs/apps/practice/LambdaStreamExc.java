...
public interface LambdaStreamExc {
     ...
     *
     * note: arbitrary number of value will be stored in a array
     *
      * @param strings
     * @return
     */
    Stream<String> createStrStream(List<String> strings);

    /**
     * Convert all strings of uppercase
     * please use createStrStream
     *
     * @param strings
     * @return
     */
    Stream<String> toUpperCase(List<String> strings);
    ...
    /**
     * Convert a IntStream range from start to end inclusive
     * @param intStream
     * @return
     */
